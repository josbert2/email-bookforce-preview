    ...
    <Body style={main}>
      <Container style={container}>
        <Section style={box}>
          ...
          <br />
          <Text style={paragraph}>
          Queremos informarte que hemos procesado exitosamente la cancelación de tu compra de tickets. 
          </Text>
          <Text style={paragraph}>
          Dado que la solicitud fue realizada fuera del plazo establecido, recibirás un reembolso parcial correspondiente al XX%  conforme a las políticas de cancelación vigentes. A continuación, te proporcionamos el detalle de la operación.
          </Text>
          <br />
